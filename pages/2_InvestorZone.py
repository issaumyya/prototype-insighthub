...
years = ["Q1-2020", "Q2-2020", "Q3-2020", "Q4-2020", "Q1-2021", "Q2-2021", "Q3-2021", "Q3-2021", "Q1-2022",
...
fig.add_trace(go.Bar(
    x=filtered_data["Timeline"],
    y=filtered_data["Funding Amount"],
    name="Funding Amount ($ Bn)",
))

fig.add_trace(go.Scatter(
    x=filtered_data["Timeline"],
    y=filtered_data["Deal Count"],
    name="Deal Count",
    mode="lines",
    yaxis="y2"
))
